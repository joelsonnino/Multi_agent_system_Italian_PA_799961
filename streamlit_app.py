...
example_queries = [
    "Plot a Piechart showing the share of each authentication_method.",
    "Plot an Horizontal barchart of the count of records in each age_group.",
    "List the first five rows of each dataset."
]
